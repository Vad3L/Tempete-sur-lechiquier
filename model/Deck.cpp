...
Deck::Deck(){
    ...
    Card c3("Not question !","Cette carte annule toute autre carte.",Turn::BEFORE,Effect::CANCELCARD);
    ...
    Card c8("Favorite","Vous pouvez à ce coup déplacer n'importe laquelle de vos pièces (sauf un pion) à la manière d'une Dame, mais vous ne pouvez pas ainsi prendre une pièce adverse.",Turn::REPLACE,Effect::NONE);
    Card c9("Atomic Bomb","Si la pièce (ou le Pion) que vous venez de déplacer n'a pas pris une pièce adverse, vous pouvez faire \"exploser\" cette pièce. Elle est alors retirée du jeu, ainsi que toutes les autres pièces, quelles que soient leur couleur, qui se trouvent sur les huit case adjacentes. Les Rois ne sont pas affectés par les explosions nucléaires.",Turn::AFTER,Effect::NONE);
    Card c10("Trap","En jouant cette carte, vous séléctionnez une case sur l'échiquier vide ou occupée par une de vos pièces. Dès qu'une pièce adverse s'arrête sur cette case, elle tombe dans une trappe et est retirée du jeu (s'il s'agit du Roi, la trappe est actionnée, mais le Roi reste sur la case).",Turn::AFTER,Effect::NONE);
    Card c11("Four corners","Si trois des quatres coins de l'échiquier sont occupés, vous pouvez amener une de vos pièces, de votre choix, dans le quatrième coin",Turn::REPLACE,Effect::NONE);
    Card c12("Exile","Vous remettez sur la case, ou sur l'une des cases où elle pouvait e trouver en début de partie, une pièce adverse de votre choix.",Turn::AFTER,Effect::NONE);
