...
namespace game {
  ...
  , m_quitAction("Quit")
  , m_newGame("New Game", game.resources.getFont("RINGM___.TTF"))
  , m_continue("Continue", game.resources.getFont("RINGM___.TTF"))
  , m_credits("Credits", game.resources.getFont("RINGM___.TTF"))
  , m_quit("Quit", game.resources.getFont("RINGM___.TTF"))
  {
  ...
  void MenuScene::doRender(gf::RenderTarget& target, const gf::RenderStates &states) {
    ...
    gf::Text title("Tempête sur L'échiquier", m_game.resources.getFont("RINGM___.TTF"), titleCharacterSize);
    ...
    m_newGame.setPosition(coords.getRelativePoint({0.275f, 0.425f +(characterSize + spaceBetweenButton)*0}));
    ...
    m_continue.setPosition(coords.getRelativePoint({0.275f, 0.425f + (characterSize + spaceBetweenButton)*1}));
